...
response = client.chat.completions.create(
    model="gpt-4o",
    messages=[
        {"role": "user", "content": "Hello, grouplay AI!"}
    ]
)
      ...
      >
        ...
        <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 10 }}>
          <Box sx={{ textAlign: 'center' }}>
            ...
            >
              欢迎来到 grouplay AI 开发者中心。这里有您需要的一切
              <br />
              让模型接入变得前所未有的简单
            </Typography>
      ...
      <Box sx={{ 
        ...
        <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1 }}>
          <Box sx={{ textAlign: 'center', mb: 10 }}>
            ...
            >
              三个简单步骤，即可完成从传统API到grouplay AI的无缝切换
              <br />
            ...
            {[
              {
                step: 1,
                title: '获取API Key',
                description: '注册并登录您的grouplay AI账户，在控制台中生成专属API密钥',
              ...
              },
              {
                step: 2,
                title: '更换Base URL',
                description: '将您原有代码中的API端点替换为grouplay AI地址',
